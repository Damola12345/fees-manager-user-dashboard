...
const ProfileDropdown = () => {
  ...
  return (
    <div tabIndex={0} className='dropDown w-[50px] flex flex-col items-end' onBlur={() => {setHeaderState(defaultHeaderState)}}>
      <div className={`
        ...
        onClick={() => setHeaderState({...defaultHeaderState, profileDropdown: !headerState.profileDropdown})}
      >
