...
const WelcomePage = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl font-light wrap text-center">
      ...
      >
        <DisplayCard>
          ...
          <p className="text-sm">Continue right where you left off!</p>
          <div
            onClick={() => {
              if (localStorage.currentSchool)
                navigate(`/schools/${localStorage.currentSchool}`);
          ...
          <div>
            ...
            >
              ...
              <FontAwesomeIcon
                icon={faUserGear}
                size="lg"
                className="group-hover transition-all duration-200"
              />
            </button>
          </div>
          <div className="self-end">
            ...
            >
              ...
              <FontAwesomeIcon
                ...
                size="lg"
                className="group-hover:translate-x-0.5 transition-all ml-2 pr-3 duration-200"
              />
            </button>
          </div>
        </DisplayCard>
      ...
      <div className="w-full mt-20 2xl:mt-[150px] md:px-20 gap-16 md:gap-0 flex flex-col md:flex-row justify-evenly items-center">
        ...
        <div className="w-full flex flex-row justify-center md:jusitfy-start items-center ml-10">
          <div className="text-sm">
            <p className="pb-5 min-w-[150px] max-w-[250px]">
